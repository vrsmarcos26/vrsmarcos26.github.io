...
document.addEventListener('DOMContentLoaded', () => {
    ...
    let gliderInstance; // Variável para armazenar a instância do carrossel
    ...
    function updateContent(lang) {
        ...
        // --- Seção de Certificações (COM A LÓGICA CORRIGIDA) ---
        ...
        if (gliderContainer && content.certifications) {
            // 1. Destrói a instância anterior do carrossel, se existir
            if (gliderInstance) { 
            ...
            gliderInstance = new Glider(gliderContainer, {
                slidesToShow: 1,
                slidesToScroll: 1,
                draggable: true,
                dots: '#dots',
